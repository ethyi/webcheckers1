...
public class ValidatorTest {
    GameView view = new GameView(Piece.Color.RED);
    ...
    public void moveTestGood() {
        assertEquals(validator.validateMove(view.getBoard(), goodMove), "True");
    }

    @Test
    public void moveTestBad() {
        assertEquals(validator.validateMove(view.getBoard(), badMove), "False");
    }
